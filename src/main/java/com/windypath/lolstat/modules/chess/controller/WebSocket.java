package com.windypath.lolstat.modules.chess.controller;
...
public class WebSocket {
    ...
    public void onMessage(String message, Session session) {
        ...
        System.out.println("用户："+msgObj.getString("username")+" 发给 用户：" + msgObj.getString("destination") + "消息：" + msgObj.getString("message"));

        sendOneMessage(msgObj.getString("destination"), message);
    }
